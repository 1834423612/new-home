...
-- 定义
('内向却又有些外向', 'Introverted... but make it extroverted'),
('喜欢狗狗', 'Dog & Cat person'),
('善良', 'Chaotic good alignment'),
('生于河北', 'Born in Hebei'),
('来自北京', 'From Beijing'),
-- 生活
('熬夜冠军', 'Professional night owl'),
('躺平爱好者', 'Certified couch potato'),
('一般通过路人', 'Just a random NPC passing by'),
('话痨', 'Can''t stop won''t stop talking'),
-- 动画 & 游戏
('❤Minecraft', '❤Minecraft'),
('GTA5', 'GTA5'),
('原神', 'Genshin Impact'),
('崩铁', 'Honkai: Star Rail'),
('Steam白嫖爱好者', 'Steam free-to-play enjoyer'),
('Terraria(泰拉瑞亚)', 'Terraria'),
('猫和老鼠', 'Tom and Jerry'),
-- 技术
('PHP 小白', 'PHP newbie'),
('熟练掌握html', 'HTML master (self-proclaimed)'),
('JavaScript 入门', 'JavaScript... barely'),
('Adobe 全家桶用户', 'Adobe Creative Suite survivor'),
('VSCode 用户', 'VSCode user'),
('Windows 用户', 'Windows user'),
('开源轮子用户', 'Open source wheel enjoyer'),
('在该用 Linux 的时候使用 Linux', 'Uses Linux when Linux should be used'),
-- 职业
('日常摸鱼学生', 'Professional slacker student'),
('喜欢编程', 'Codes for fun'),
('愿望是上学期间睡个好觉', 'Dreams of sleeping well during school'),
-- 文化
('二次元爱好者', 'ACG enthusiast'),
('梗图王就是我没错了', 'Certified meme lord'),
('多元思维推崇者', 'Open-minded thinker'),
('爱与和平', 'Love & peace'),
('爱好和平', 'Peace lover'),
('反向思维', 'Thinks outside the box (and the room)'),
('什么类型都可以吃一点', 'Will try anything once'),
-- 设备&工具
('麦当劳与KFC通吃', 'McDonald''s AND KFC — no loyalty'),
('LENOVO Legion用户', 'Lenovo Legion user'),
('Linux服务器用户', 'Linux server user'),
('米粉', 'Xiaomi fan'),
('微软大法好', 'Microsoft is the way'),
('键盘爱好者', 'Mechanical keyboard enthusiast'),
('DIY爱好者', 'DIY enthusiast'),
('对于苹果系统一窍不通', 'Definitely not an Apple user, escpecially when it comes to macOS'),
('垃圾佬', 'Bargain bin archaeologist'),
('二手爱好者', 'Secondhand treasure hunter'),
('洋垃圾爱好者', 'Imported e-waste connoisseur'),
('魔改硬件爱好者', 'Hardware modding addict'),
('装机猿', 'PC building lover'),
('瞎折腾', 'Tinkerer of random things'),
-- 短句
('你记住我了吗，当你试着多roll几个标签的时候，我就赢了☜(ﾟヮﾟ☜)', 'Remember me? If you keep rolling, I already win ☜(ﾟヮﾟ☜)'),
('刚刚走神了，这个不算，再roll一个', 'Oops, spaced out — that one doesn''t count. Try again!'),
('你很幸运，roll到了这个毫无意义的标签，请再roll一个', 'Lucky you! A completely meaningless tag. Try again'),
('感谢来访这个无名的小站点，祝你有个美好的一天~', 'Thanks for visiting this little corner of the internet. Have a great day~');
