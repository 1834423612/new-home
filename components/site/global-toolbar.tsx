  ...
  return (
    <div className="fixed top-4 right-4 z-50 flex items-center gap-2">
      ...
      <div className="relative" ref={pickerRef}>
        <button onClick={() => setShowThemes(!showThemes)} className="flex h-9 w-9 items-center justify-center rounded-full border border-border bg-card/90 text-muted-foreground hover:border-primary hover:text-primary transition-all duration-300 backdrop-blur-md" aria-label={dict.theme.settings}>
