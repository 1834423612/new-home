...
export function ExperiencesManager() {
  ...
  const sort = useSortable<ExperienceRow>({
    items,
    apiEndpoint: "/api/admin/experiences",
  ...
  return (
    <div>
      ...
      {showForm && !sort.sortMode && <ExperienceForm initial={editing} onSave={handleSave} onCancel={() => { setShowForm(false); setEditing(null) }} />}
