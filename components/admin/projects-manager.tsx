...
import { SortToolbar, SortList } from "./sort-controls"
...
export function ProjectsManager() {
  ...
  const sort = useSortable<ProjectRow>({
    items,
    apiEndpoint: "/api/admin/projects",
    onRefresh: fetchItems,
    transformBeforeSave: (item) => ({ ...item, tags: parseTags(item.tags as string | string[]) }),
  })
